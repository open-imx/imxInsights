...
from imxInsights.utils.shapely.shapely_geojson import ShapelyGeoJsonFeatureCollection, CrsEnum


def calculate_measurements(imx: ImxContainer, create_geojson_debug: bool = False, out_path: Path | str | None = None):
